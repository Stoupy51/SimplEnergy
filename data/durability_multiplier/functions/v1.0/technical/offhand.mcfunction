...
item replace block -29999999 0 2013 container.0 from entity @s weapon.offhand
scoreboard players operation @s durability_multiplier.offhand -= #damage durability_multiplier.data
execute store result block -29999999 0 2013 Items[0].tag.Damage int 1 run scoreboard players get @s durability_multiplier.offhand
item replace entity @s weapon.offhand from block -29999999 0 2013 container.0
