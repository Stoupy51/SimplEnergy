...
item replace block -29999999 0 2013 container.0 from entity @s armor.feet
scoreboard players operation @s durability_multiplier.feet -= #damage durability_multiplier.data
execute store result block -29999999 0 2013 Items[0].tag.Damage int 1 run scoreboard players get @s durability_multiplier.feet
item replace entity @s armor.feet from block -29999999 0 2013 container.0
