...
item replace block -29999999 0 2013 container.0 from entity @s armor.head
scoreboard players operation @s durability_multiplier.head -= #damage durability_multiplier.data
execute store result block -29999999 0 2013 Items[0].tag.Damage int 1 run scoreboard players get @s durability_multiplier.head
item replace entity @s armor.head from block -29999999 0 2013 container.0
