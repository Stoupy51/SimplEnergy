...
#Choose Type Of Furnace and do recipes
	execute if score #type furnace_nbt_recipes.data matches 0 if score #cook_time furnace_nbt_recipes.data matches 190.. in minecraft:overworld run function furnace_nbt_recipes:v1.0/technical/shulker_manipulation
	execute unless score #type furnace_nbt_recipes.data matches 0 if score #cook_time furnace_nbt_recipes.data matches 90.. in minecraft:overworld run function furnace_nbt_recipes:v1.0/technical/shulker_manipulation
