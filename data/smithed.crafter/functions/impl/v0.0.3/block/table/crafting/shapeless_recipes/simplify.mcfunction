...
execute if data storage smithed.crafter:main root.temp.shapeless_crafting_input[] run function smithed.crafter:impl/v0.0.3/block/table/crafting/shapeless_recipes/
