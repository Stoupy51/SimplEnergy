...
# get values (x100)
execute store result score #10armor smithed.damage run attribute @s generic.armor get 10
execute store result score #10toughness smithed.damage run attribute @s generic.armor_toughness get 10
