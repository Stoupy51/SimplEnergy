...
execute store result score #success simplenergy.data unless data storage simplenergy:items furnace.Items[{Slot:2b}]
...
execute if score #success simplenergy.data matches 1 run data modify storage simplenergy:items furnace.Items append from block -29999999 0 2013 Items[{Slot:2b}]
...
execute if score #success simplenergy.data matches 0 store result score #count_2 simplenergy.data run data get storage simplenergy:items furnace.Items[{Slot:2b}].Count
...
execute if score #success simplenergy.data matches 0 store result storage simplenergy:items furnace.Items[{Slot:2b}].Count byte 1 run scoreboard players get count simplenergy.data
