...
#Storage manipulation
	...
	data modify storage simplenergy:items furnace.input_ctc set from storage simplenergy:items furnace.Items[{Slot:0b}].tag.ctc

	scoreboard players set #found simplenergy.data 0
	data modify block -29999999 0 2013 Items set from storage simplenergy:items furnace.Items
