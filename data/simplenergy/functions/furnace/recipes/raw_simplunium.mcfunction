...
execute unless score output_cmd simplenergy.data matches 0 unless score output_cmd simplenergy.data matches 2012898 run scoreboard players set CookTime simplenergy.data 0
