...
tellraw @a[tag=convention.debug] {"text":"[Loaded SimplEnergy v2.0.0]","color":"green"}

scoreboard objectives add simplenergy.timer_data dummy
scoreboard objectives add simplenergy.right_click minecraft.used:minecraft.warped_fungus_on_a_stick

scoreboard players set #SimplEnergyLoaded load.status 1
