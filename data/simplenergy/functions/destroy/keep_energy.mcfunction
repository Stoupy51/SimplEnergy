...
scoreboard players operation Part1 simplenergy.data = @s energy.storage
scoreboard players operation Part2 simplenergy.data = @s energy.storage
scoreboard players operation Part1 simplenergy.data /= 1000 simplenergy.data
scoreboard players operation Part2 simplenergy.data %= 1000 simplenergy.data
scoreboard players operation Part2 simplenergy.data /= 10 simplenergy.data
execute store result storage simplenergy:energy Energy int 1 run scoreboard players get @s energy.storage
execute store result storage simplenergy:energy Part1 int 1 run scoreboard players get Part1 simplenergy.data
execute store result storage simplenergy:energy Part2 int 1 run scoreboard players get Part2 simplenergy.data
