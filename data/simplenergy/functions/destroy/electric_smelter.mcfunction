#Kill undesired Items & Replace the item to keep Motion
    ...
    data modify entity @e[type=minecraft:item,nbt={Item:{id:"minecraft:furnace"}},limit=1,sort=nearest,distance=..1] Item set from storage simplenergy:items 2012202
kill @s
