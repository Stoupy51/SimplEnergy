...
data modify entity @e[type=item,nbt={Item:{id:"minecraft:gold_block"}},limit=1,sort=nearest,distance=..1] Item set from storage simplenergy:main all.advanced_battery
