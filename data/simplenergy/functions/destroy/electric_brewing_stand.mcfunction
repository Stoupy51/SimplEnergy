...
data modify entity @e[type=item,nbt={Item:{id:"minecraft:brewing_stand"}},limit=1,sort=nearest,distance=..1] Item set from storage simplenergy:main all.electric_brewing_stand
