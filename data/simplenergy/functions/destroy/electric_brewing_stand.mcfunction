#Kill undesired Items & Replace the item to keep Motion
    ...
    data modify entity @e[type=minecraft:item,nbt={Item:{id:"minecraft:brewing_stand"}},limit=1,sort=nearest,distance=..1] Item set from storage simplenergy:items 2012204
kill @s
