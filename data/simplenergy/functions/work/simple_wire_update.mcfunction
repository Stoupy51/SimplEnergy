...
execute positioned ~ ~-1 ~ if entity @e[tag=EF_Use,tag=!EF_Wire,limit=1,sort=nearest,distance=..0.2] at @s positioned ~ ~1 ~ if entity @e[tag=EF_Use,tag=!EF_Wire,limit=1,sort=nearest,distance=..0.2] run item replace entity @s weapon.offhand with cobblestone{CustomModelData:2012103}
