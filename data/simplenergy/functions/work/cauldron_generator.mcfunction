...
execute if score @s SE_SimpleGen matches 90.. run setblock ~ ~ ~ minecraft:water_cauldron[level=1]
execute if score @s SE_SimpleGen matches 180.. run setblock ~ ~ ~ minecraft:cauldron
execute if score @s SE_SimpleGen matches 180.. run scoreboard players reset @s SE_SimpleGen
