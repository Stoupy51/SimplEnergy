...
execute if score Temp simplenergy.data matches 1 if score DayTime simplenergy.data matches 13500..22500 run scoreboard players add @s energy.storage 1
execute if score Temp simplenergy.data matches 1 unless score DayTime simplenergy.data matches 13500..22500 run scoreboard players add @s energy.storage 4
