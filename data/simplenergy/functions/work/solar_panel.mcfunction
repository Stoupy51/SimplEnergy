...
execute if score #success simplenergy.data matches 1 run scoreboard players add @s energy.storage 1
execute if score #success simplenergy.data matches 0 run scoreboard players add @s energy.storage 4
