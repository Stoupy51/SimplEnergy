...
execute if data storage simplenergy:items Furnace.Items[{Slot:0b,id:"minecraft:barrel"}] unless data storage simplenergy:items Furnace.Items[{Slot:0b}].tag.SE_Cookable run scoreboard players set CookTime SE_Data2 0
