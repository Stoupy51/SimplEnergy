#Choose Type Of Furnace
	...
	execute if data storage simplenergy:items Furnace.RecipesUsed."simplenergy:command_block" if score CookTime SE_Data matches ..8 run function simplenergy:work/all_furnace_2
	execute if data storage simplenergy:items Furnace.RecipesUsed."simplenergy:command_block_blast" if score CookTime SE_Data matches ..8 run function simplenergy:work/all_furnace_2
...
execute if data storage simplenergy:items Furnace.Items[{Slot:0b,id:"minecraft:command_block"}] unless data storage simplenergy:items Furnace.Items[{Slot:0b}].tag.SE_Cookable run scoreboard players set CookTime SE_Data 0
