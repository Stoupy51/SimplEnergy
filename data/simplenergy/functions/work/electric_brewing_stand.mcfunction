...
#Change Fuel value and use Energy
    ...
    execute unless score BrewTime SE_Data matches 4.. unless score Fuel SE_Data matches 21.. run scoreboard players remove @s EF_kJ 1
...
#Change gui texture
    data modify block ~ ~ ~ Items insert 0 value {Slot:4b,id:"minecraft:cobblestone",Count:1b,tag:{CustomModelData:2011936,SE_CustomTextureItem:1b,display:{Name:'[{"text":""}]'}}}
