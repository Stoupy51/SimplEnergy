...
#Change gui texture
	data modify block ~ ~ ~ Items insert 0 value {Slot:1b,id:"minecraft:cobblestone",Count:1b,tag:{CustomModelData:2011998,SF_CustomItem:1b,SE_CustomTextureItem:1b,display:{Name:'[{"text":""}]'}}}
