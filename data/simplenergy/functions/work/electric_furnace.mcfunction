...
#Change CookTime value and use Energy & playsound on work
	...
	execute if score #cook_time simplenergy.data matches 1.. run playsound simplenergy:electric_furnace block @a[distance=..10,tag=!simplenergy.ps.electric_furnace] ~ ~ ~ 0.25
	execute if score #cook_time simplenergy.data matches 1.. run tag @a[distance=..10] add simplenergy.ps.electric_furnace
