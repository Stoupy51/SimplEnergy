...
#Change CookTime value and use Energy & playsound on work
	...
	execute if score #second simplenergy.data matches 0 if score #cook_time simplenergy.data matches 1.. run playsound simplenergy:electric_smelter block @a[distance=..10] ~ ~ ~ 0.25
