...
#Placing Ore
	...
	execute at @s if block ~ ~ ~ #simplenergy:for_simplunium_ore run summon glow_item_frame ~ ~ ~ {ItemRotation:0b,Tags:["global.ignore","global.ignore.kill","smithed.block","SimplEnergy_Destroyer","SimplEnergy_SimpluniumOre"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"cobblestone",Count:1b,tag:{CustomModelData:2012899}}}
	execute at @s if block ~ ~ ~ #simplenergy:for_simplunium_ore run setblock ~ ~ ~ deepslate_coal_ore
	execute at @s positioned ~0.8 ~0.8 ~0.8 if block ~ ~ ~ #simplenergy:for_simplunium_ore run summon glow_item_frame ~ ~ ~ {ItemRotation:0b,Tags:["global.ignore","global.ignore.kill","smithed.block","SimplEnergy_Destroyer","SimplEnergy_SimpluniumOre"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"cobblestone",Count:1b,tag:{CustomModelData:2012899}}}
	execute at @s positioned ~0.8 ~0.8 ~0.8 if block ~ ~ ~ #simplenergy:for_simplunium_ore run setblock ~ ~ ~ deepslate_coal_ore
	execute at @s positioned ~ ~0.8 ~0.8 if block ~ ~ ~ #simplenergy:for_simplunium_ore run summon glow_item_frame ~ ~ ~ {ItemRotation:0b,Tags:["global.ignore","global.ignore.kill","smithed.block","SimplEnergy_Destroyer","SimplEnergy_SimpluniumOre"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"cobblestone",Count:1b,tag:{CustomModelData:2012899}}}
	execute at @s positioned ~ ~0.8 ~0.8 if block ~ ~ ~ #simplenergy:for_simplunium_ore run setblock ~ ~ ~ deepslate_coal_ore
	execute at @s positioned ~0.8 ~0.8 ~ if block ~ ~ ~ #simplenergy:for_simplunium_ore run summon glow_item_frame ~ ~ ~ {ItemRotation:0b,Tags:["global.ignore","global.ignore.kill","smithed.block","SimplEnergy_Destroyer","SimplEnergy_SimpluniumOre"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"cobblestone",Count:1b,tag:{CustomModelData:2012899}}}
	execute at @s positioned ~0.8 ~0.8 ~ if block ~ ~ ~ #simplenergy:for_simplunium_ore run setblock ~ ~ ~ deepslate_coal_ore
	execute at @s positioned ~0.8 ~ ~0.8 if block ~ ~ ~ #simplenergy:for_simplunium_ore run summon glow_item_frame ~ ~ ~ {ItemRotation:0b,Tags:["global.ignore","global.ignore.kill","smithed.block","SimplEnergy_Destroyer","SimplEnergy_SimpluniumOre"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"cobblestone",Count:1b,tag:{CustomModelData:2012899}}}
	execute at @s positioned ~0.8 ~ ~0.8 if block ~ ~ ~ #simplenergy:for_simplunium_ore run setblock ~ ~ ~ deepslate_coal_ore
	execute at @s positioned ~ ~0.8 ~ if block ~ ~ ~ #simplenergy:for_simplunium_ore run summon glow_item_frame ~ ~ ~ {ItemRotation:0b,Tags:["global.ignore","global.ignore.kill","smithed.block","SimplEnergy_Destroyer","SimplEnergy_SimpluniumOre"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"cobblestone",Count:1b,tag:{CustomModelData:2012899}}}
