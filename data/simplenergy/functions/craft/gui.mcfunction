item replace block ~ ~ ~ container.0 with minecraft:cobblestone{CustomModelData:2011929,SE_CustomTextureItem:1b,display:{Name:'[{"text":""}]'}}
item replace block ~ ~ ~ container.1 with minecraft:cobblestone{CustomModelData:2011929,SE_CustomTextureItem:1b,display:{Name:'[{"text":""}]'}}
item replace block ~ ~ ~ container.5 with minecraft:cobblestone{CustomModelData:2011929,SE_CustomTextureItem:1b,display:{Name:'[{"text":""}]'}}
item replace block ~ ~ ~ container.6 with minecraft:cobblestone{CustomModelData:2011929,SE_CustomTextureItem:1b,display:{Name:'[{"text":""}]'}}
item replace block ~ ~ ~ container.7 with minecraft:cobblestone{CustomModelData:2011929,SE_CustomTextureItem:1b,display:{Name:'[{"text":""}]'}}
item replace block ~ ~ ~ container.8 with minecraft:cobblestone{CustomModelData:2011929,SE_CustomTextureItem:1b,display:{Name:'[{"text":""}]'}}
...
item replace block ~ ~ ~ container.25 with minecraft:cobblestone{CustomModelData:2011929,SE_CustomTextureItem:1b,display:{Name:'[{"text":""}]'}}
item replace block ~ ~ ~ container.26 with minecraft:cobblestone{CustomModelData:2011930,SE_CustomTextureItem:1b,display:{Name:'[{"text":""}]'}}
