...
execute store result score Count SE_Data if data storage simplenergy:items all.Crafting[{tag:{SE_CustomTextureItem:1b,CustomModelData:2011929}}]
execute unless data storage simplenergy:items all.Crafting[{Slot:16b,tag:{SE_CustomTextureItem:1b}}] run scoreboard players add Count SE_Data 1
...
#Check Crafts with only Vanilla Items
	...
	execute as @s[tag=!SE_FoundCraft] store success score Success SE_Data unless data storage simplenergy:items all.Crafting[{Slot:2b,tag:{SF_CustomItem:1b}}] unless data storage simplenergy:items all.Crafting[{Slot:3b,tag:{SF_CustomItem:1b}}] unless data storage simplenergy:items all.Crafting[{Slot:4b,tag:{SF_CustomItem:1b}}] unless data storage simplenergy:items all.Crafting[{Slot:11b,tag:{SF_CustomItem:1b}}] unless data storage simplenergy:items all.Crafting[{Slot:12b,tag:{SF_CustomItem:1b}}] unless data storage simplenergy:items all.Crafting[{Slot:13b,tag:{SF_CustomItem:1b}}] unless data storage simplenergy:items all.Crafting[{Slot:20b,tag:{SF_CustomItem:1b}}] unless data storage simplenergy:items all.Crafting[{Slot:21b,tag:{SF_CustomItem:1b}}] unless data storage simplenergy:items all.Crafting[{Slot:22b,tag:{SF_CustomItem:1b}}] run function simplenergy:craft/types/all_vanilla
