...
execute store result score Count SE_Data if data storage simplenergy:items Crafting[{tag:{SE_CustomTextureItem:1s,CustomModelData:2011929}}]
execute unless data storage simplenergy:items Crafting[{Slot:16b,tag:{SE_CustomTextureItem:1s}}] run scoreboard players add Count SE_Data 1
...
#Check Crafts with only Vanilla Items
	...
	execute as @s[tag=!SE_FoundCraft] store success score Success SE_Data unless data storage simplenergy:items Crafting[{Slot:2b,tag:{CustomItem:1s}}] unless data storage simplenergy:items Crafting[{Slot:3b,tag:{CustomItem:1s}}] unless data storage simplenergy:items Crafting[{Slot:4b,tag:{CustomItem:1s}}] unless data storage simplenergy:items Crafting[{Slot:11b,tag:{CustomItem:1s}}] unless data storage simplenergy:items Crafting[{Slot:12b,tag:{CustomItem:1s}}] unless data storage simplenergy:items Crafting[{Slot:13b,tag:{CustomItem:1s}}] unless data storage simplenergy:items Crafting[{Slot:20b,tag:{CustomItem:1s}}] unless data storage simplenergy:items Crafting[{Slot:21b,tag:{CustomItem:1s}}] unless data storage simplenergy:items Crafting[{Slot:22b,tag:{CustomItem:1s}}] run function simplenergy:craft/types/all_vanilla
