...
execute store result score Crafted SE_Data2 run data get storage simplenergy:items all.Crafting[{Slot:16b}].tag.CustomModelData
execute store result score Count SE_Data2 run data get storage simplenergy:items all.Crafting[{Slot:16b}].Count
