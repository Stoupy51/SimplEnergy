...
execute if block ~ ~ ~ minecraft:furnace{BurnTime:0s} run data modify entity @s ArmorItems[3].tag.CustomModelData set value 2012001
execute unless block ~ ~ ~ minecraft:furnace{BurnTime:0s} run data modify entity @s ArmorItems[3].tag.CustomModelData set value 2012002
