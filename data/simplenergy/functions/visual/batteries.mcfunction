...
setblock 0 0 0 oak_sign{Text1:'[{"text":"[Charge : ","italic":false,"color":"gray"},{"nbt":"Part1","storage":"simplenergy:energy"},{"text":"."},{"nbt":"Part2","storage":"simplenergy:energy"},{"text":"/"},{"nbt":"MaxP1","storage":"simplenergy:energy"},{"text":"."},{"nbt":"MaxP2","storage":"simplenergy:energy"},{"text":" kJ]"}]'}
