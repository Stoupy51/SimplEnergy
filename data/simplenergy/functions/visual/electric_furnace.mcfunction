...
#Update gui depends on CookTime
	...
	execute if score CookTime simplenergy.data matches 0 run data modify entity @s Item.tag.CustomModelData set value 2012200
	execute unless score CookTime simplenergy.data matches 0 run data modify entity @s Item.tag.CustomModelData set value 2012201
