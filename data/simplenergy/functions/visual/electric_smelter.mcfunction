#Update gui depends on CookTime
	execute store result score CookTime simplenergy.data run data get block ~ ~ ~ CookTime
	...
	execute if score CookTime simplenergy.data matches 0 run data modify entity @s Item.tag.CustomModelData set value 2012202
	execute unless score CookTime simplenergy.data matches 0 run data modify entity @s Item.tag.CustomModelData set value 2012203
