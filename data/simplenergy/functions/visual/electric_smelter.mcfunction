...
execute if score CookTime SE_Timer matches 0 run data modify entity @s Item.tag.CustomModelData set value 2012202
execute unless score CookTime SE_Timer matches 0 run data modify entity @s Item.tag.CustomModelData set value 2012203
