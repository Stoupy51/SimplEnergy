...
#Others
	execute at @e[type=minecraft:armor_stand,tag=SE_AdvancedWire] run particle minecraft:dust 0 1 1 1 ~ ~1 ~ 0.25 0.1 0.25 0 1
	execute at @e[type=minecraft:armor_stand,tag=SE_EliteWire] run particle minecraft:dust 1 0 0 1 ~ ~1 ~ 0.25 0.1 0.25 0 1
