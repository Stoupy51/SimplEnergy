...
#Collect power
	...
	execute align xyz positioned ~ ~1 ~ as @e[type=#energy:valid_block_entities,tag=!simplenergy.balance,tag=!simplenergy.balanced,tag=simplenergy.balancing,dx=0,dy=0,dz=0] if score @s energy.max_storage = #temp simplenergy.data at @s run function simplenergy:balance/found
	execute align xyz positioned ~ ~-1 ~ as @e[type=#energy:valid_block_entities,tag=!simplenergy.balance,tag=!simplenergy.balanced,tag=simplenergy.balancing,dx=0,dy=0,dz=0] if score @s energy.max_storage = #temp simplenergy.data at @s run function simplenergy:balance/found
	execute align xyz positioned ~ ~ ~1 as @e[type=#energy:valid_block_entities,tag=!simplenergy.balance,tag=!simplenergy.balanced,tag=simplenergy.balancing,dx=0,dy=0,dz=0] if score @s energy.max_storage = #temp simplenergy.data at @s run function simplenergy:balance/found
	execute align xyz positioned ~ ~ ~-1 as @e[type=#energy:valid_block_entities,tag=!simplenergy.balance,tag=!simplenergy.balanced,tag=simplenergy.balancing,dx=0,dy=0,dz=0] if score @s energy.max_storage = #temp simplenergy.data at @s run function simplenergy:balance/found
	execute align xyz positioned ~1 ~ ~ as @e[type=#energy:valid_block_entities,tag=!simplenergy.balance,tag=!simplenergy.balanced,tag=simplenergy.balancing,dx=0,dy=0,dz=0] if score @s energy.max_storage = #temp simplenergy.data at @s run function simplenergy:balance/found
...
#Redistributes Energy
	...
	scoreboard players operation @e[type=#energy:valid_block_entities,tag=simplenergy.balance] energy.storage = #balance simplenergy.data
