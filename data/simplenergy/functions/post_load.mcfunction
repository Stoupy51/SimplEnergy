...
execute if score GameVersion EF_Versions matches 2724.. if score EnergyFlux EF_Versions matches 1013.. run tellraw @a {"text":"[Loaded SimplEnergy v1.3.0]","italic":false,"color":"green"}
