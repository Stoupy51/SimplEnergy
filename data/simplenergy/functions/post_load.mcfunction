...
execute if score GameVersion EF_Versions matches 2724.. if score EnergyFlux EF_Versions matches 1013.. run tellraw @a {"text":"[Loaded SimplEnergy v1.2.4]","italic":false,"color":"green"}
