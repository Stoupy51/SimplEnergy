...
execute if score EnergyFlux EF_Versions matches ..1013 run tellraw @a {"text":"SimplEnergy Error: Energy Flux API v1.1.5+ is needed, click [here] to download","italic":false,"color":"red","clickEvent":{"action":"open_url","value":"https://github.com/Stoupy51/EnergyFlux-API/releases"}}
execute if score GameVersion EF_Versions matches 2724.. if score EnergyFlux EF_Versions matches 1014.. run tellraw @a {"text":"[Loaded SimplEnergy v1.3.3]","italic":false,"color":"green"}
