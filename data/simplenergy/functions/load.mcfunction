...
scoreboard players set SimplEnergy load.status 1090
...
#Tools/Equipments
	...
	#Simplunium Armor/Tools
		data modify storage simplenergy:main all.2012101 set value {Slot:16b,id:"minecraft:leather_helmet"				,Count:1b,tag:{ctc:{id:"simplunium_helmet",from:"stoupy:simplenergy",traits:{"metal/simplunium":1b,"armor":1b}}							,CustomModelData:2012101,simplenergy:{simplunium:1b,simplunium_helmet:1b}		,HideFlags:64,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Slot:"head",Amount:4,Operation:0,UUID:[I;201302,201302,201302,201303]}	,{AttributeName:"generic.armor_toughness",Name:"generic.armor_toughness",Slot:"head",Amount:2,Operation:0,UUID:[I;201302,201302,201303,201303]}]						,display:{color:3487029,Lore:['{"translate":"SimplEnergy","color":"blue","italic":true}']	,Name:'[{"text":"Simplunium Helmet","italic":false,"color":"white"}]'}}}
