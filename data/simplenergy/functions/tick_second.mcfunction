#Others
	...
	execute as @e[type=glow_item_frame,tag=SimplEnergy_Destroyer] run function simplenergy:opti/tick_second_glows
	...
	execute at @a run function simplenergy:generate/player
