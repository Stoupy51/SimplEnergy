...
summon item_frame ~ ~ ~ {ItemRotation:0b,Tags:["SimplEnergy_Destroyer","SimplEnergy_SimpleCable","SimplEnergy_Cable","SimplEnergy_SetNew","energy.cable"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"cobblestone",Count:1b,tag:{CustomModelData:2012300}}}
kill @s
