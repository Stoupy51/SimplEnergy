...
summon item_frame ~ ~ ~ {ItemRotation:0b,Tags:["SE_Destroyer","SE_AdvancedWire","EF_Use","SE_SetNew","EF_Wire"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"cobblestone",Count:1b,tag:{CustomModelData:2012400}}}
