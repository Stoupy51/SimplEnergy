...
function furnace_nbt_recipes:v1.1/advancements/placed_furnace

execute align xyz positioned ~.5 ~.5 ~.5 summon item_display at @s run function simplenergy:place/electric_furnace/secondary
