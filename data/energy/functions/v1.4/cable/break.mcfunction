...
execute align xyz positioned ~ ~1 ~ as @e[type=#energy:valid_block_entities,dx=0,dy=0,dz=0] at @s run function energy:v1.4/cable/break_2
...
execute as @e[type=#energy:valid_block_entities,tag=!energy.cable,predicate=energy:v1.4/has_network_id] at @s run function energy:v1.4/cable/break_reconnect
...
execute as @e[type=#energy:valid_block_entities,tag=energy.cable] at @s run function energy:v1.4/cable/setup_cable_network
