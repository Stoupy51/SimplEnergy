...
execute store result score #helm smd.damage run data get storage smithed:core temp.Inventory[{Slot:103b}].tag.Enchantments[{id:"minecraft:blast_protection"}].lvl
execute store result score #chest smd.damage run data get storage smithed:core temp.Inventory[{Slot:102b}].tag.Enchantments[{id:"minecraft:blast_protection"}].lvl
execute store result score #legs smd.damage run data get storage smithed:core temp.Inventory[{Slot:101b}].tag.Enchantments[{id:"minecraft:blast_protection"}].lvl
execute store result score #boots smd.damage run data get storage smithed:core temp.Inventory[{Slot:100b}].tag.Enchantments[{id:"minecraft:blast_protection"}].lvl
