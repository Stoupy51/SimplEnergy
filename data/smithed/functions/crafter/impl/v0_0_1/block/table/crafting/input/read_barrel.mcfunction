...
function smithed:crafter/impl/v0_0_1/block/table/crafting/input/handle_tags
...
execute if data storage smd:crafter root.temp.crafting_input{0:[{}],1:[{}],2:[{}]} unless data storage smd:crafter root.temp.crafting_input{0:[{id:"minecraft:air",Slot:1b},{id:"minecraft:air",Slot:2b}],1:[{id:"minecraft:air",Slot:1b},{id:"minecraft:air",Slot:2b}],2:[{id:"minecraft:air",Slot:1b},{id:"minecraft:air",Slot:2b}]} if entity @s[scores={smd.data=0}] run function smithed:crafter/impl/v0_0_1/block/table/crafting/input/mirror

execute if data storage smd:crafter root.temp.crafting_input{0:[{}],1:[{}],2:[]} unless data storage smd:crafter root.temp.crafting_input{0:[{id:"minecraft:air",Slot:1b},{id:"minecraft:air",Slot:2b}],1:[{id:"minecraft:air",Slot:1b},{id:"minecraft:air",Slot:2b}]} if entity @s[scores={smd.data=0}] run function smithed:crafter/impl/v0_0_1/block/table/crafting/input/mirror

execute if data storage smd:crafter root.temp.crafting_input{0:[{}],1:[],2:[]} unless data storage smd:crafter root.temp.crafting_input{0:[{id:"minecraft:air",Slot:1b},{id:"minecraft:air",Slot:2b}]} if entity @s[scores={smd.data=0}] run function smithed:crafter/impl/v0_0_1/block/table/crafting/input/mirror

execute if entity @s[scores={smd.data=0}] run function smithed:crafter/impl/v0_0_1/block/table/crafting/shapeless_recipes
