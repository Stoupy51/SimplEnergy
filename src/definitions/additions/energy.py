...
def main_additions() -> None:
	...
	Block(
		...
		override_model={
			"parent":"minecraft:block/cauldron", "textures": {"particle": f"{ns}:item/cauldron_generator_side", "side": f"{ns}:item/cauldron_generator_side", "top": f"{ns}:item/cauldron_generator_top", "bottom": f"{ns}:item/cauldron_generator_bottom", "inside": f"{ns}:item/cauldron_generator_base"},
			"display":{
