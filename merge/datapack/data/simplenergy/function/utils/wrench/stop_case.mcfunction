...
execute store result score #success simplenergy.data as @e[tag=simplenergy.rotatable,limit=1,sort=nearest,dx=0,dy=0,dz=0] at @s run function simplenergy:utils/wrench/rotate
