...
#> simplenergy:v2.0.27/load/enumerate
#
...
execute if score #simplenergy.major load.status matches 2 if score #simplenergy.minor load.status matches 0 unless score #simplenergy.patch load.status matches 27.. run scoreboard players set #simplenergy.patch load.status 27
