...
execute if score @s energy.storage matches 10.. if data storage simplenergy:temp all.Items[{Slot:0b}] run function simplenergy:custom_blocks/electric_furnace/work
...
execute if score @s energy.storage matches 1..199 run item replace block ~ ~ ~ container.1 with cobblestone[custom_model_data=2012992,hide_tooltip={},custom_data={"common_signals":{"temp":true}}]
execute if score @s energy.storage matches 200..399 run item replace block ~ ~ ~ container.1 with cobblestone[custom_model_data=2012991,hide_tooltip={},custom_data={"common_signals":{"temp":true}}]
execute if score @s energy.storage matches 400..599 run item replace block ~ ~ ~ container.1 with cobblestone[custom_model_data=2012990,hide_tooltip={},custom_data={"common_signals":{"temp":true}}]
execute if score @s energy.storage matches 600..799 run item replace block ~ ~ ~ container.1 with cobblestone[custom_model_data=2012989,hide_tooltip={},custom_data={"common_signals":{"temp":true}}]
execute if score @s energy.storage matches 800.. run item replace block ~ ~ ~ container.1 with cobblestone[custom_model_data=2012988,hide_tooltip={},custom_data={"common_signals":{"temp":true}}]
