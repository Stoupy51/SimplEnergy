...
execute if score @s energy.storage matches ..0 run item replace block ~ ~ ~ container.1 with minecraft:command_block[item_model="simplenergy:gui/electric_furnace_4",tooltip_display={"hide_tooltip":true},custom_data={"common_signals":{"temp":true}}]
...
execute if score @s energy.storage matches 400..799 run item replace block ~ ~ ~ container.1 with minecraft:command_block[item_model="simplenergy:gui/electric_furnace_0",tooltip_display={"hide_tooltip":true},custom_data={"common_signals":{"temp":true}}]
execute if score @s energy.storage matches 800..1199 run item replace block ~ ~ ~ container.1 with minecraft:command_block[item_model="simplenergy:gui/electric_furnace_2",tooltip_display={"hide_tooltip":true},custom_data={"common_signals":{"temp":true}}]
execute if score @s energy.storage matches 1200..1599 run item replace block ~ ~ ~ container.1 with minecraft:command_block[item_model="simplenergy:gui/electric_furnace_5",tooltip_display={"hide_tooltip":true},custom_data={"common_signals":{"temp":true}}]
execute if score @s energy.storage matches 1600.. run item replace block ~ ~ ~ container.1 with minecraft:command_block[item_model="simplenergy:gui/electric_furnace_3",tooltip_display={"hide_tooltip":true},custom_data={"common_signals":{"temp":true}}]
