...
execute if score @s energy.storage matches ..0 run item replace block ~ ~ ~ container.26 with cobblestone[item_model="simplenergy:pulverizer_0",tooltip_display={"hide_tooltip": true},custom_data={"common_signals":{"temp":true}}]
execute if score @s energy.storage matches 1..1599 run item replace block ~ ~ ~ container.26 with cobblestone[item_model="simplenergy:pulverizer_1",tooltip_display={"hide_tooltip": true},custom_data={"common_signals":{"temp":true}}]
execute if score @s energy.storage matches 1600..3199 run item replace block ~ ~ ~ container.26 with cobblestone[item_model="simplenergy:pulverizer_2",tooltip_display={"hide_tooltip": true},custom_data={"common_signals":{"temp":true}}]
execute if score @s energy.storage matches 3200..4799 run item replace block ~ ~ ~ container.26 with cobblestone[item_model="simplenergy:pulverizer_3",tooltip_display={"hide_tooltip": true},custom_data={"common_signals":{"temp":true}}]
execute if score @s energy.storage matches 4800..6399 run item replace block ~ ~ ~ container.26 with cobblestone[item_model="simplenergy:pulverizer_4",tooltip_display={"hide_tooltip": true},custom_data={"common_signals":{"temp":true}}]
execute if score @s energy.storage matches 6400.. run item replace block ~ ~ ~ container.26 with cobblestone[item_model="simplenergy:pulverizer_5",tooltip_display={"hide_tooltip": true},custom_data={"common_signals":{"temp":true}}]
