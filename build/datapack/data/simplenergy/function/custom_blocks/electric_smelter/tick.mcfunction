...
execute if score @s energy.storage matches 1..1999 run item replace block ~ ~ ~ container.1 with minecraft:command_block[item_model="simplenergy:gui/electric_smelter_1",tooltip_display={"hide_tooltip": true},custom_data={"common_signals":{"temp":true}}]
execute if score @s energy.storage matches 2000..3999 run item replace block ~ ~ ~ container.1 with minecraft:command_block[item_model="simplenergy:gui/electric_smelter_2",tooltip_display={"hide_tooltip": true},custom_data={"common_signals":{"temp":true}}]
execute if score @s energy.storage matches 4000..5999 run item replace block ~ ~ ~ container.1 with minecraft:command_block[item_model="simplenergy:gui/electric_smelter_3",tooltip_display={"hide_tooltip": true},custom_data={"common_signals":{"temp":true}}]
...
execute if score @s energy.storage matches 8000.. run item replace block ~ ~ ~ container.1 with minecraft:command_block[item_model="simplenergy:gui/electric_smelter_5",tooltip_display={"hide_tooltip": true},custom_data={"common_signals":{"temp":true}}]
