...
#
# @within	simplenergy:custom_blocks/_groups/minecraft_iron_trapdoor
#
...
execute as @n[type=item,nbt={Item:{id:"minecraft:iron_trapdoor"}},distance=..1] run function simplenergy:custom_blocks/wind_turbine/replace_item
