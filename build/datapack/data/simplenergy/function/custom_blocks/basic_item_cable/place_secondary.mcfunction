...
#
# @within	simplenergy:custom_blocks/basic_item_cable/place_main
#
...
item replace entity @s container.0 with minecraft:furnace[item_model="simplenergy:basic_item_cable"]
