...
execute if score #temp simplenergy.data matches -6.. run return 0
...
execute if predicate simplenergy:is_jumping positioned ~ ~2 ~ run return run function simplenergy:custom_blocks/elevator/go_up
