...
#> simplenergy:custom_blocks/elevator/place_main
#
...
execute align xyz positioned ~0.5 ~0.5 ~0.5 summon item_display at @s run function simplenergy:custom_blocks/elevator/place_secondary
...
scoreboard players add #total_elevator simplenergy.data 1
