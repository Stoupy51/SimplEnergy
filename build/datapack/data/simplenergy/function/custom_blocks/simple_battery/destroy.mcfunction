...
#
# @within	simplenergy:custom_blocks/_groups/minecraft_waxed_copper_block
#
...
execute as @n[type=item,nbt={Item:{id:"minecraft:waxed_copper_block"}},distance=..1] run function simplenergy:custom_blocks/simple_battery/replace_item

# Decrease count scores
scoreboard players remove #total_custom_blocks simplenergy.data 1
scoreboard players remove #total_vanilla_waxed_copper_block simplenergy.data 1
