...
# @executed	at @s
#
# @within	simplenergy:custom_blocks/advanced_battery/place_main [ at @s ]
#
...
# Add a custom name
data merge entity @s {"CustomName": {"translate": "simplenergy.advanced_battery"}}

# Modify item display entity to match the custom block
item replace entity @s contents with minecraft:furnace[item_model="simplenergy:advanced_battery"]
