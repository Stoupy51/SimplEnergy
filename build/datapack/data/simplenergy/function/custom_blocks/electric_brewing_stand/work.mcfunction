...
execute if score #cook_time simplenergy.data matches 1.. store result block ~ ~ ~ BrewTime int 1 run scoreboard players get #cook_time simplenergy.data
...
execute if score #old_burn_time simplenergy.data matches ..200 store result block ~ ~ ~ Fuel int 1 run scoreboard players get #burn_time simplenergy.data
