...
execute if score @s energy.storage matches 600..1199 run item replace block ~ ~ ~ container.4 with minecraft:command_block[item_model="simplenergy:gui/electric_brewing_stand_2",tooltip_display={"hide_tooltip": true},custom_data={"common_signals":{"temp":true}}]
execute if score @s energy.storage matches 1200..1799 run item replace block ~ ~ ~ container.4 with minecraft:command_block[item_model="simplenergy:gui/electric_brewing_stand_3",tooltip_display={"hide_tooltip": true},custom_data={"common_signals":{"temp":true}}]
execute if score @s energy.storage matches 1800..2399 run item replace block ~ ~ ~ container.4 with minecraft:command_block[item_model="simplenergy:gui/electric_brewing_stand_4",tooltip_display={"hide_tooltip": true},custom_data={"common_signals":{"temp":true}}]
execute if score @s energy.storage matches 2400.. run item replace block ~ ~ ~ container.4 with minecraft:command_block[item_model="simplenergy:gui/electric_brewing_stand_5",tooltip_display={"hide_tooltip": true},custom_data={"common_signals":{"temp":true}}]
