...
#
# @within	simplenergy:v2.0.11/tick_2 [ as @e[type=item_display,tag=...,predicate=!simplenergy:check_vanilla_blocks] & at @s ]
#			simplenergy:v2.0.11/second [ as @e[type=#simplenergy:custom_blocks,tag=...,predicate=!simplenergy:advanced_check_vanilla_blocks] & at @s ]
#			simplenergy:v2.0.11/second_5 [ as @e[type=item_display,tag=simplenergy.custom_block,predicate=!simplenergy:advanced_check_vanilla_blocks] & at @s ]
...
execute if score #total_vanilla_conduit simplenergy.data matches 1.. if entity @s[tag=simplenergy.vanilla.minecraft_conduit] unless block ~ ~ ~ minecraft:conduit run function simplenergy:custom_blocks/_groups/minecraft_conduit
...
execute if score #total_vanilla_iron_trapdoor simplenergy.data matches 1.. if entity @s[tag=simplenergy.vanilla.minecraft_iron_trapdoor] unless block ~ ~ ~ minecraft:iron_trapdoor run function simplenergy:custom_blocks/_groups/minecraft_iron_trapdoor
...
execute if score #total_vanilla_waxed_copper_block simplenergy.data matches 1.. if entity @s[tag=simplenergy.vanilla.minecraft_waxed_copper_block] unless block ~ ~ ~ minecraft:waxed_copper_block run function simplenergy:custom_blocks/_groups/minecraft_waxed_copper_block
