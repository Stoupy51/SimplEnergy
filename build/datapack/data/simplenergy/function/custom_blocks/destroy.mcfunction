...
#
# @within	simplenergy:v2.0.22/tick_2 [ as @e[type=item_display,tag=...,predicate=!simplenergy:check_vanilla_blocks] & at @s ]
#			simplenergy:v2.0.22/second [ as @e[type=#simplenergy:custom_blocks,tag=...,predicate=!simplenergy:advanced_check_vanilla_blocks] & at @s ]
#			simplenergy:v2.0.22/second_5 [ as @e[type=item_display,tag=simplenergy.custom_block,predicate=!simplenergy:advanced_check_vanilla_blocks] & at @s ]
