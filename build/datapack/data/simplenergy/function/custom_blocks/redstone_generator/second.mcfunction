...
execute if score #burn_time simplenergy.data matches 0 run item replace block ~ ~ ~ container.1 with cobblestone[item_model="simplenergy:gui/redstone_generator",tooltip_display={"hide_tooltip": true},custom_data={"common_signals":{"temp":true}}]
