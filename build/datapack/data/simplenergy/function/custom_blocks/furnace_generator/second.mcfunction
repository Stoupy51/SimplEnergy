...
execute if score #burn_time simplenergy.data matches 0 run item replace block ~ ~ ~ container.0 with minecraft:command_block[item_model="simplenergy:gui/furnace_generator",tooltip_display={"hide_tooltip": true},custom_data={"common_signals":{"temp":true}}]
...
execute if score #burn_time simplenergy.data matches 1.. run item replace block ~ ~ ~ container.0 with minecraft:command_block[item_model="simplenergy:gui/furnace_generator_on",tooltip_display={"hide_tooltip": true},custom_data={"common_signals":{"temp":true}}]
