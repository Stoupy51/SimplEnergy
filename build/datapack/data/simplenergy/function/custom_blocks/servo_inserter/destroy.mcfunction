...
#> simplenergy:custom_blocks/servo_inserter/destroy
#
...
execute as @n[type=item,nbt={Item:{components:{"minecraft:custom_data":{"simplenergy":{"item_frame_destroy":true}}}}},distance=..1] run function simplenergy:custom_blocks/servo_inserter/replace_item
...
scoreboard players remove #total_servo_inserter simplenergy.data 1
