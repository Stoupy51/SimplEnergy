...
# Add a custom name
data merge entity @s {"CustomName": {"translate": "simplenergy.heat_generator"}}

# Modify item display entity to match the custom block
item replace entity @s contents with minecraft:furnace[item_model="simplenergy:heat_generator"]
