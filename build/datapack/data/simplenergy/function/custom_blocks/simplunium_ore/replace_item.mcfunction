...
execute if score #is_silk_touch simplenergy.data matches 1 run data modify entity @s Item.id set from storage simplenergy:items all.simplunium_ore.id
execute if score #is_silk_touch simplenergy.data matches 1 run data modify entity @s Item.components set from storage simplenergy:items all.simplunium_ore.components
