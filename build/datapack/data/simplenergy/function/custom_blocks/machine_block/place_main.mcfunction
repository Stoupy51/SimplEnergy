...
#> simplenergy:custom_blocks/machine_block/place_main
#
...
execute align xyz positioned ~0.5 ~0.5 ~0.5 summon item_display at @s run function simplenergy:custom_blocks/machine_block/place_secondary
...
scoreboard players add #total_machine_block simplenergy.data 1
