...
execute if score #dependency_error simplenergy.data matches 1 if score #smithed.crafter.major load.status matches 0 if score #smithed.crafter.minor load.status matches 3 unless score #smithed.crafter.patch load.status matches 1.. run tellraw @a {"translate":"simplenergy.smithed_crafter","color":"gold","clickEvent":{"action":"open_url","value":"https://wiki.smithed.dev/libraries/crafter/"}}
...
execute if score #dependency_error simplenergy.data matches 1 if score #furnace_nbt_recipes.major load.status matches 1 unless score #furnace_nbt_recipes.minor load.status matches 4.. run tellraw @a {"translate":"simplenergy.furnace_nbt_recipes","color":"gold","clickEvent":{"action":"open_url","value":"https://github.com/Stoupy51/FurnaceNbtRecipes"}}
