...
# Check nearby heat_generator recursively
execute align xyz positioned ~ ~1 ~ as @e[tag=simplenergy.heat_generator,tag=simplenergy.can_balance,tag=!simplenergy.adjacent,dx=0,dy=0,dz=0] if score @s energy.max_storage = #max_storage simplenergy.data at @s run function simplenergy:balancing/heat_generator/found
execute align xyz positioned ~ ~-1 ~ as @e[tag=simplenergy.heat_generator,tag=simplenergy.can_balance,tag=!simplenergy.adjacent,dx=0,dy=0,dz=0] if score @s energy.max_storage = #max_storage simplenergy.data at @s run function simplenergy:balancing/heat_generator/found
execute align xyz positioned ~ ~ ~1 as @e[tag=simplenergy.heat_generator,tag=simplenergy.can_balance,tag=!simplenergy.adjacent,dx=0,dy=0,dz=0] if score @s energy.max_storage = #max_storage simplenergy.data at @s run function simplenergy:balancing/heat_generator/found
execute align xyz positioned ~ ~ ~-1 as @e[tag=simplenergy.heat_generator,tag=simplenergy.can_balance,tag=!simplenergy.adjacent,dx=0,dy=0,dz=0] if score @s energy.max_storage = #max_storage simplenergy.data at @s run function simplenergy:balancing/heat_generator/found
execute align xyz positioned ~1 ~ ~ as @e[tag=simplenergy.heat_generator,tag=simplenergy.can_balance,tag=!simplenergy.adjacent,dx=0,dy=0,dz=0] if score @s energy.max_storage = #max_storage simplenergy.data at @s run function simplenergy:balancing/heat_generator/found
