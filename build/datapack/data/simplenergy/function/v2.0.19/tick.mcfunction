...
#> simplenergy:v2.0.19/tick
#
# @within	simplenergy:v2.0.19/load/tick_verification
#
...
execute if score #tick_2 simplenergy.data matches 3.. run function simplenergy:v2.0.19/tick_2
execute if score #second simplenergy.data matches 20.. run function simplenergy:v2.0.19/second
execute if score #second_5 simplenergy.data matches 90.. run function simplenergy:v2.0.19/second_5
