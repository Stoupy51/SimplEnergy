...
execute if score #dependency_error simplenergy.data matches 0 if score #furnace_nbt_recipes.major load.status matches 1 unless score #furnace_nbt_recipes.minor load.status matches 8.. run scoreboard players set #dependency_error simplenergy.data 1
...
execute if score #dependency_error simplenergy.data matches 0 if score #itemio.major load.status matches 1 if score #itemio.minor load.status matches 3 unless score #itemio.patch load.status matches 2.. run scoreboard players set #dependency_error simplenergy.data 1
