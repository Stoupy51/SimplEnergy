...
#> simplenergy:v2.0.21/load/check_dependencies
#
...
execute if score #dependency_error simplenergy.data matches 0 if score #common_signals.major load.status matches 0 if score #common_signals.minor load.status matches 2 unless score #common_signals.patch load.status matches 1.. run scoreboard players set #dependency_error simplenergy.data 1
...
execute if score #dependency_error simplenergy.data matches 0 if score #smart_ore_generation.major load.status matches 1 if score #smart_ore_generation.minor load.status matches 7 unless score #smart_ore_generation.patch load.status matches 3.. run scoreboard players set #dependency_error simplenergy.data 1
