...
#> simplenergy:v2.0.9/load/valid_dependencies
#
# @within	simplenergy:v2.0.9/load/secondary
#			simplenergy:v2.0.9/load/valid_dependencies 1t replace
#

# Waiting for a player to get the game version, but stop function if no player found
execute unless entity @p run schedule function simplenergy:v2.0.9/load/valid_dependencies 1t replace
...
# Load SimplEnergy
execute if score #game_version simplenergy.data matches 1.. if score #mcload_error simplenergy.data matches 0 if score #dependency_error simplenergy.data matches 0 run function simplenergy:v2.0.9/load/confirm_load
