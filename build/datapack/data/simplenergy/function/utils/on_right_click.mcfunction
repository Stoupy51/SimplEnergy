...
execute if data storage simplenergy:main SelectedItemTag.simplenergy.battery_switcher run function simplenergy:utils/battery_switcher/right_click/main
