...
#
# @within	simplenergy:utils/multimeter/passive/found_entity 1 replace
#			simplenergy:utils/multimeter/passive/remove_markers 1 replace
#
...
execute if score #success simplenergy.data matches 1 run schedule function simplenergy:utils/multimeter/passive/remove_markers 1 replace
