...
#> simplenergy:v2.0.12/load/enumerate
#
...
execute if score #simplenergy.major load.status matches 2 if score #simplenergy.minor load.status matches 0 unless score #simplenergy.patch load.status matches 12.. run scoreboard players set #simplenergy.patch load.status 12
