...
execute if entity @s[tag=simplenergy.simple_cable] run item replace entity @s contents with minecraft:recovery_compass[item_model="simplenergy:simple_cable"]
execute if entity @s[tag=simplenergy.advanced_cable] run item replace entity @s contents with minecraft:recovery_compass[item_model="simplenergy:advanced_cable"]
