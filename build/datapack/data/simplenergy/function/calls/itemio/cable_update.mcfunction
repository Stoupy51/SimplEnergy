...
execute if entity @s[tag=simplenergy.basic_item_cable] run item replace entity @s contents with <member 'base_item' of 'Item' objects>[item_model="simplenergy:basic_item_cable"]
