...
execute if score #dimension smart_ore_generation.data matches 0.. if predicate {"type": "minecraft:random_chance","chance": 0.5} run function simplenergy:calls/smart_ore_generation/veins/simplunium_ore
...
execute if score #dimension smart_ore_generation.data matches 0.. if predicate {"type": "minecraft:random_chance","chance": 0.5} run function simplenergy:calls/smart_ore_generation/veins/deepslate_simplunium_ore
