...
#> simplenergy:v2.0.18/load/confirm_load
#
# @within	simplenergy:v2.0.18/load/valid_dependencies
#
...
# Confirm load
tellraw @a[tag=convention.debug] {"translate":"simplenergy.loaded_simplenergy_v2_0_18","color":"green"}
scoreboard players set #simplenergy.loaded load.status 1
function simplenergy:v2.0.18/load/set_items_storage
